...
public class TileEntityTutorielSpecialRenderer extends TileEntitySpecialRenderer {
    ...
    {
        this.renderTileEntityTutorielAt((TileEntityVoid)tile, x, y, z, partialRenderTick); // j'appelle ma fonction renderTileEntityTutorielAt en castant TileEntityTutoriel à l'argument tile
    }
